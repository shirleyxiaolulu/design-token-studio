(function () {
  ...
  function typography(platform, base, fontStack) {
    if (platform === "ios-app") {
      return {
        ...
        "font.size.caption2": { value: 11 },
        "font.size.caption1": { value: 12 },
        "font.size.footnote": { value: 13 },
        "font.size.subhead": { value: 15 },
        "font.size.body": { value: base },
        "font.size.title3": { value: 20 },
        "font.size.title2": { value: 22 },
        "font.size.title1": { value: 28 },
        "font.size.largeTitle": { value: 34 },
        "font.lineHeight.body": { value: Math.round(base * 1.42) },
      };
    }
  ...
  function generateTokens(seed) {
    ...
    const commonColors = {
      ...
      "color.common.dark.overlay": ["rgba(0, 0, 0, 0.72)", "rgba(0, 0, 0, 0.72)", "深色遮罩原始值"],
      "color.common.overlay": ["rgba(15, 23, 42, 0.48)", "rgba(15, 23, 42, 0.48)", "浅色遮罩原始值"],
